var Swiper = function() {
    ...
    , function(e) {
        ...
        function c(e) {
            ...
            if (t.params.loop) {
                ...
                r = a,
                (r %= n = t.slides.length) == 1 + (i %= n) ? "next" : r === i - 1 ? "previous" : void 0);
    ...
    , function(e) {
        ...
        function P() {
            ...
            i && (r = i.querySelector(te(t.params.scrollbar.dragClass)),
    ...
    , function(e) {
        ...
        function P(e) {
            if ("mouse" === e.pointerType && h.splice(0, h.length),
            !M(e))
                return;
            ...
            !(h.length < 2)) {
                ...
                !g.slideEl) {
                    ...
                    g.imageEl = a,
                    g.imageWrapEl = a ? E(g.imageEl, "." + s.containerClass)[0] : void 0,
                    !g.imageWrapEl)
        ...
        function L(e) {
            ...
            h.length < 2 || (m = !0,
            g.scaleMove = S(),
            g.imageEl && (a.scale = g.scaleMove / g.scaleStart * l,
            a.scale > g.maxRatio && (a.scale = g.maxRatio - 1 + (a.scale - g.maxRatio + 1) ** .5),
        ...
        function I(e) {
            ...
            u && m && (u = !1,
            m = !1,
            g.imageEl && (a.scale = Math.max(Math.min(a.scale, g.maxRatio), s.minRatio),
            g.imageEl.style.transitionDuration = t.params.speed + "ms",
            g.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`,
            l = a.scale,
            o = !1,
            a.scale > 1 && g.slideEl ? g.slideEl.classList.add("" + s.zoomedSlideClass) : a.scale <= 1 && g.slideEl && g.slideEl.classList.remove("" + s.zoomedSlideClass),
            1 === a.scale && (g.originX = 0,
            g.originY = 0,
            g.slideEl = void 0)))
        }
        function z() {
        ...
        function A(e) {
            ...
            const i = v.width * a.scale
              , r = v.height * a.scale;
            if (v.minX = Math.min(g.slideWidth / 2 - i / 2, 0),
            v.maxX = -v.minX,
            ...
            v.currentX = v.touchesCurrent.x - v.touchesStart.x + v.startX + n * (v.width - 2 * c),
            v.currentY = v.touchesCurrent.y - v.touchesStart.y + v.startY + n * (v.height - 2 * p),
            ...
            b.x = (v.touchesCurrent.x - b.prevPositionX) / (Date.now() - b.prevTime) / 2,
            b.y = (v.touchesCurrent.y - b.prevPositionY) / (Date.now() - b.prevTime) / 2,
        ...
        function D(e) {
            ...
            if (!g.slideEl) {
                ...
                g.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? g.slideEl = f(t.slidesEl, "." + t.params.slideActiveClass)[0] : g.slideEl = t.slides[t.activeIndex]);
                let s = g.slideEl.querySelector("." + a.containerClass);
                s && (s = s.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]),
                g.imageEl = s,
                g.imageWrapEl = s ? E(g.imageEl, "." + a.containerClass)[0] : void 0
            }
            ...
            void 0 === v.touchesStart.x && e ? (i = e.pageX,
            r = e.pageY) : (i = v.touchesStart.x,
            r = v.touchesStart.y);
        ...
        function G() {
            ...
            if (!g.slideEl) {
                ...
                g.imageEl = e,
                g.imageWrapEl = e ? E(g.imageEl, "." + s.containerClass)[0] : void 0
            }
        ...
        a("touchStart", (e, s) => {
            t.zoom.enabled && function(e) {
                ...
                v.touchesStart.x = a.pageX,
                v.touchesStart.y = a.pageY
            }(s)
        }
        ),
        a("touchEnd", (e, s) => {
    ...
    , function(e) {
        ...
        i("afterInit", () => {
            t.params.a11y.enabled && ( () => {
                ...
                const i = t.wrapperEl
                  , r = e.id || i.getAttribute("id") || "swiper-wrapper-" + (void 0 === (n = 16) && (n = 16),
