!function(e) {
        ...
        t.hasClass("categorySlider")) {
            ...
            !function t() {
                ...
                document.querySelectorAll(".single").forEach(t => {
                    ...
                    t.style.transform = `translate(0, ${n}px) rotate(${-i * e.rotate}deg)`,
    ...
    var s, o, r, l, c = ".ajax-contact", d = '[name="email"]', u = e(".form-messages");
    function p() {
        var t = e(c).serialize();
        (function() {
            var t, a = !0;
    ...
    e(document).on("click", (function(t) {
        e(t.target).closest(s).length || e(t.target).closest(o).length || e(s).removeClass(l)
    }
    )),
    ...
    e.fn.sectionPosition = function(t, a) {
        e(this).each((function() {
            ...
            "top-half" === n ? (e(s).css("padding-bottom", r + i + "px"),
            l.css("margin-top", "-" + i + "px")) : "bottom-half" === n && (e(s).css("padding-top", o + i + "px"),
    ...
    function y() {
        e(".feature-circle .progressbar").each((function() {
            ...
            parseInt(100, 10),
            e(this).data("animate"));
            a < i + e(window).height() - 30 && !s && (e(this).data("animate", !0),
    ...
    e.fn.countdown = function() {
        e(this).each((function() {
            ...
            var n = setInterval((function() {
                ...
                s < 0 ? (clearInterval(n),
                t.addClass("expired"),
                t.find(".message").css("display", "block")) : (i(".day").html(o),
                i(".hour").html(r),
                i(".minute").html(l),
                i(".seconds").html(c))
            }
    ...
    e.fn.lettering = function(t) {
        return t && T[t] ? T[t].apply(this, [].slice.call(arguments, 1)) : "letters" !== t && t ? (e.error("Method " + t + " does not exist on jQuery.lettering"),
        this) : T.init.apply(this, [].slice.call(arguments, 0))
    }
    ,
    ...
    function A() {
        P || (window.innerWidth > 991 ? (S || (S = new Lenis({
            lerp: .07
        }),
